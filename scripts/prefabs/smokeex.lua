...
local firelevels = 
{
    {anim="level1", sound="dontstarve/common/nightlight", radius=1, intensity=.8, falloff=.33, colour = {253/255,179/255,179/255}, soundintensity=.1},
...
local function fn(Sim)
    ...
    inst.AnimState:SetMultColour(203/255, 9/255, 9/255, .6)
...
return Prefab( "common/fx/smokeex", fn, assets) 
